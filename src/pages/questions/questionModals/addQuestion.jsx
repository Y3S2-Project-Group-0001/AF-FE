      ...
      <div  className="fixed inset-0 z-50 flex items-center justify-center" >
        ...
        <div className="relative bg-gray-200 rounded-lg w-3/6">
          ...
          <div className="flex justify-end px-4 pb-4">
            ...
            <button role='button' aria-label="suc-but" onClick={validation} className="px-4 py-2 rounded-md text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:bg-blue-700">Add Question</button>
          </div>
        </div>
      </div>
    </div>
